...
@section('breadcrumb')
	<ul class="breadcrumb">
	    ...
	    <li class="breadcrumb-item"><a href="javascript:">List Category</a></li>
	</ul>
@endsection
          ...
          <div class="card">
              <div class="card-header">
                  ...
                  <div class="d-flex justify-content-between">
                      <div class="text-left">
                        <a class="btn btn-info" href="{{ route('admin.categories.create') }}"><i class="feather icon-plus"></i> Add</a>
                      </div>
