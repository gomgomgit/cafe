                      ...
                      <div class="col-lg-12">
                          <form action="{{ route('admin.ingredients.store') }}" method="post">
                              ...
                              <div class="form-group">
                                  ...
                                  <input type="text" class="form-control" id="data-name" name="name" placeholder="Ingredient Name">
                              </div>
                              <div class="form-group">
                                  <label for="data-stock">Stock</label>
                                  <input type="text" class="form-control" id="data-stock" name="stock" placeholder="Ingredient Stock">
                              </div>
