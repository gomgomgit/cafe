...
<link rel="stylesheet" href="{{ asset('css/ydcustom') }}">
...
@section('breadcrumb')
	<ul class="breadcrumb">
	    ...
	    <li class="breadcrumb-item"><a href="#!">Ingredient</a></li>
	    <li class="breadcrumb-item"><a href="javascript:">List Ingredient</a></li>
	</ul>
@endsection
          ...
          <div class="card">
              <div class="card-header">
                  ...
                  <div class="d-flex justify-content-between">
                      <div class="text-left">
                        <a class="btn btn-info" href="{{ route('admin.ingredients.create') }}"><i class="feather icon-plus"></i> Add</a>
                      </div>
                      {{-- <div class="text-right">
                        <a class="btn btn-danger" href="{{ route('admin.ingredients.trash') }}"><i class="feather icon-trash"></i> Trash</a>
                      </div> --}}
                  </div>
              </div>
