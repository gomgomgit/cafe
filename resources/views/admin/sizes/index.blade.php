...
@section('breadcrumb')
	<ul class="breadcrumb">
	    ...
	    <li class="breadcrumb-item"><a href="javascript:">List Size</a></li>
	</ul>
@endsection
          ...
          <div class="card">
              <div class="card-header">
                  ...
                  <div class="d-flex justify-content-between">
                      <div class="text-left">
                        <a class="btn btn-info" href="{{ route('admin.sizes.create') }}"><i class="feather icon-plus"></i> Add</a>
                      </div>
                      {{-- <div class="text-right">
                        <a class="btn btn-danger" href="{{ route('admin.sizes.trash') }}"><i class="feather icon-trash"></i> Trash</a>
                      </div> --}}
                  </div>
              </div>
