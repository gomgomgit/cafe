...
@section('breadcrumb')
	<ul class="breadcrumb">
	    ...
	    <li class="breadcrumb-item"><a href="javascript:">Add Sizes</a></li>
	</ul>
@endsection
      ...
      <div class="col-sm-12">
          <div class="card">
              <div class="card-header">
                  ...
                  <div class="row">
                      <div class="col-lg-12">
                          <form action="{{ route('admin.sizes.update', $data->id) }}" method="post">
                              @csrf
                              @method('PUT')
                              @if ($errors->any())
                              ...
                              <div class="form-group">
                                  ...
                                  <input type="text" class="form-control" id="data-name" name="name" placeholder="Sizes Name" value="{{ old('name', $data->name) }}">
                              </div>
