				...
				<section class="lattest-product-area pb-40 category-list">
					<div class="row">
						...
						@foreach($items as $item)
							...
							<div class="col-lg-4 col-md-6" x-data="detail({{ $item->id }})">
								<div class="single-product">
									<img class="img-fluid" src="{{ asset('image/'. $item->image) }}" alt="">
									<div class="product-details">
										<h6>{{ $item->name }}</h6>
										<button class="btn btn-info w-100" x-on:click="setPrice()" data-toggle="modal" data-target="#itemdetail{{ $item->id }}">
											ADD
										</button>
									</div>
								</div>
								{{-- Modal --}}
								<div class="modal fade" id="itemdetail{{ $item->id }}" tabindex="-1" role="dialog" aria-labelledby="itemdetailTitle{{ $item->id }}" aria-hidden="true">
								      ...
								      <form action="" method="post">
									      <div class="modal-body">
									      	...
									      	<div class="form-group">
									      	  ...
									      	  <select class="form-control" id="variant" name="variant_id" x-model="variant" x-on:change="setPrice()">
									      	  	@php
									      	...
									      	<div class="form-group">
									      	  ...
									      	  <select class="form-control" id="size" name="size_id" x-model="size" x-on:change="setPrice()">
									      	  	@php
									      	...
									      	<div>
									      		<p>Price: </p>
									      		<p class="text-right font-weight-bold m-0" x-text="itemprice"></p>
									      	</div>

									      	<div class="form-group">
									      	  <label for="quantity" class="col-form-label">Qty:</label>
									      	  <input type="text" class="form-control" id="quantity" name="qty" x-model="qty" x-on:change="setPrice()">
									      	</div>

									      	<div class="text-right font-weight-bold">
									      		<p class="">Total : <span x-text="pricetotal"></span></p>
									      	</div>
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
					...
					<div class="row align-items-center">
						<div class="col-lg-6">
							<div class="quick-view-carousel">
								<div class="item" style="background: url({{ asset('karma/img/organic-food/q1.jpg') }});">
	...
	<script src="{{asset('karma/https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.11.0/umd/popper.min.js')}}" integrity="sha384-b/U6ypiBEHpOf/4+1nzFpr53nxSS+GLCkfwBdFNTxtclqqenISfwAzpKaMNFNmj4"
